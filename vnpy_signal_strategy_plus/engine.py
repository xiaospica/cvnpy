...
class SignalEnginePlus(BaseEngine):
    ...
    def __init__(self, main_engine: MainEngine, event_engine: EventEngine):
        ...
        self.strategies: Dict[str, SignalTemplatePlus] = {}
        self.symbol_strategy_map: defaultdict = defaultdict(list)
        self.orderid_strategy_map: Dict[str, SignalTemplatePlus] = {}
    ...
    def call_strategy_func(
        self, strategy: SignalTemplatePlus, func: callable, params: Any = None
    ) -> None:
        """
    ...
    def add_strategy(
        self,
        strategy_class: Union[str, Type[SignalTemplatePlus]]
    ) -> None:
        """
        Add a new strategy.
        """
    ...
    def write_log(self, msg: str, strategy: SignalTemplatePlus = None) -> None:
        """
    ...
    def put_strategy_event(self, strategy: SignalTemplatePlus) -> None:
        ...
        event = Event(EVENT_SIGNAL_STRATEGY_PLUS, data)
        self.event_engine.put(event)
