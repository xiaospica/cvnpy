...
class BacktestingEngine:
    ...
    def __init__(self) -> None:
        ...
        self.strategy_class: type[SignalTemplatePlus]
        self.strategy: SignalTemplatePlus
        self.tick: TickData
        self.bar: BarData
    ...
    def add_strategy(self, strategy_class: type[SignalTemplatePlus], setting: dict) -> None:
        """"""
    ...
    def new_bar(self, bar: BarData) -> None:
        ...
        if hasattr(self.strategy, "on_timer"):
    ...
    def send_order(
        ...
        """"""
        order_type: OrderType = OrderType.STOP if stop else OrderType.LIMIT
        return self.send_order_by_vt_symbol(
            strategy, self.vt_symbol, direction, offset, price, volume, order_type, lock, net
        )

    def send_order_by_vt_symbol(
        self,
        strategy: SignalTemplatePlus,
        vt_symbol: str,
        direction: Direction,
        ...
        if vt_symbol != self.vt_symbol:
            self.output(_("回测引擎当前仅支持单标的，下单失败：{}").format(vt_symbol))
            return []
    ...
    def cancel_order(self, strategy: SignalTemplatePlus, vt_orderid: str) -> None:
        """
    ...
    def cancel_limit_order(self, strategy: SignalTemplatePlus, vt_orderid: str) -> None:
        """"""
    ...
    def cancel_all(self, strategy: SignalTemplatePlus) -> None:
        """
    ...
    def write_log(self, msg: str, strategy: SignalTemplatePlus | None = None) -> None:
        """
        Write log message.
        """
    ...
    def send_email(self, msg: str, strategy: SignalTemplatePlus | None = None) -> None:
        """
        Send email to default receiver.
        """
        pass

    def sync_strategy_data(self, strategy: SignalTemplatePlus) -> None:
        """
    ...
    def get_pricetick(self, strategy: SignalTemplatePlus) -> float:
        """
        Return contract pricetick data.
        """
        return self.pricetick

    def get_size(self, strategy: SignalTemplatePlus) -> float:
        """
        Return contract size data.
        """
        return self.size

    def put_strategy_event(self, strategy: SignalTemplatePlus) -> None:
        """
...
def evaluate(
    target_name: str,
    strategy_class: type[SignalTemplatePlus],
    vt_symbol: str,
    interval: Interval,
    start: datetime,
    rate: float,
