...
class LocaleBuildHook(BuildHookInterface):
    ...
    def initialize(self, version: str, build_data: dict) -> None:
        ...
        self.locale_path: Path = Path(self.root).joinpath("vnpy_signal_strategy_plus_backtester", "locale")
        self.mo_path: Path = self.locale_path.joinpath("en", "LC_MESSAGES", "vnpy_signal_backtester.mo")
        self.po_path: Path = self.locale_path.joinpath("en", "LC_MESSAGES", "vnpy_ctabacktester.po")
