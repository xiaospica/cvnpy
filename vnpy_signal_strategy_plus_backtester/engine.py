...
import vnpy_signal_strategy_plus
from vnpy_signal_strategy_plus import SignalTemplatePlus, MySQLSignalStrategyPlus
from vnpy_signal_strategy_plus.backtesting import (
    BacktestingEngine,
    OptimizationSetting,
    BacktestingMode
)
...
APP_NAME = "SignalBacktester"

EVENT_BACKTESTER_LOG = "eSignalBacktesterLog"
EVENT_BACKTESTER_BACKTESTING_FINISHED = "eSignalBacktesterBacktestingFinished"
EVENT_BACKTESTER_OPTIMIZATION_FINISHED = "eSignalBacktesterOptimizationFinished"


class SignalBacktesterEngine(BaseEngine):
    """
    ...
    def init_engine(self) -> None:
        """"""
        self.write_log(_("初始化Signal回测引擎"))
    ...
    def load_strategy_class(self) -> None:
        ...
        """
        app_path: Path = Path(vnpy_signal_strategy_plus.__file__).parent
        path1: Path = app_path.joinpath("strategies")
        self.load_strategy_class_from_folder(path1, "vnpy_signal_strategy_plus.strategies")
        ...
        try:
            ...
            for name in dir(module):
                ...
                if (
                    ...
                    and issubclass(value, SignalTemplatePlus)
                    and value not in {SignalTemplatePlus, MySQLSignalStrategyPlus}
                ):
    ...
    def run_backtesting(
        ...
        strategy_class: type[SignalTemplatePlus] = self.classes[class_name]
        engine.add_strategy(
            strategy_class,
            setting
        )
